...
import csv
import os
def get_player_table(school_name,player_name,player_table_type,player_subtable_name):
 

	file_needed  = open("C:/Users/lchen/Desktop/school_raw_data/"+school_name+"/"+player_name+'_'+player_table_type+".txt","r")
	lines = []
	...
	for line in lines:
		if(in_table and end_of_table):
			...
			if(in_table and in_columns and in_row==False and line.count(' ')<=1):
				...
				break
			elif(line.strip() == player_subtable_name):
				in_table = True
	...
	directory = 'C:/Users/lchen/Desktop/Chenjie_7_teams/'+school_name+'/'+player_name+'/'+player_table_type
	if not os.path.exists(directory):
		os.makedirs(directory)
	with open('C:/Users/lchen/Desktop/Chenjie_7_teams/'+school_name+'/'+player_name+'/'+player_table_type+'/'+player_name+'_'+player_table_type+'_'+player_subtable_name+'.csv','w', newline = '') as ft:
